        ...
        if($display_btn == "on" && $user_role_wise == 0){
            ...
            if(!empty($items) && isset($items)){
                ...
                foreach ($items as $item => $values) {
                    ...
                    // $product_img_url = get_the_post_thumbnail_url($values['product_id']);
            ...
            $button_html = '<div class="mmwea-buuton-box"><a href="{{btn_url}}" id="wa-order-button-click" class="mmwea-wa-button  button btn {{btn_class}}" {{btn_target}} ><img src="'.MMWEA_PLUGIN_URL.'/assets/image/whatsapp_phone_icon.svg" width="50" height="50" ><span>{{btn_text}}</span></a></div>';
