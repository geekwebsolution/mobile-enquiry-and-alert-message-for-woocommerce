<?php
if (!class_exists('MMWEA_Update_Checker')) {

    class MMWEA_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'mmwea_plugin_updates';
